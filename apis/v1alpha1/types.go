...
// +kubebuilder:resource:scope=Namespaced,categories={crossplane,provider,provider-makefile-test}
// A ProviderConfig configures a provider-makefile-test provider.
...
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:printcolumn:name="SECRET-NAME",type="string",JSONPath=".spec.credentials.secretRef.name",priority=1
// +kubebuilder:resource:scope=Cluster,categories={crossplane,provider,provider-makefile-test}
// A ClusterProviderConfig configures a provider-makefile-test provider.
