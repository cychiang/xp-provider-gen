...
// +kubebuilder:resource:scope=Namespaced,categories={crossplane,provider,gitignore-test}
// A ProviderConfig configures a gitignore-test provider.
...
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:printcolumn:name="SECRET-NAME",type="string",JSONPath=".spec.credentials.secretRef.name",priority=1
// +kubebuilder:resource:scope=Cluster,categories={crossplane,provider,gitignore-test}
// A ClusterProviderConfig configures a gitignore-test provider.
